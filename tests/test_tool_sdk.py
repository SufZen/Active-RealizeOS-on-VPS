...
class TestToolRegistrySingleton:
    ...
    def test_get_tool_registry_bootstraps_auto_discovery(self):
        import realize_core.tools.tool_registry as mod

        mod._registry = None

        def mark_auto_discovered(self):
            self._auto_discovered = True

        with pytest.MonkeyPatch.context() as monkeypatch:
            monkeypatch.setattr(ToolRegistry, "auto_discover", mark_auto_discovered)
