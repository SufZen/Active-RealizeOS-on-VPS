...
class TestClassifyTask:
    ...
    def test_content_draft(self):
        assert classify_task("draft a newsletter for our clients") == "content"
    ...
    def test_reasoning_strategy(self):
        assert classify_task("analyze our market positioning strategy") == "reasoning"
    ...
    def test_none_message_defaults_to_simple(self):
        """None message should default to 'simple' without crashing."""
    ...
    def test_general_question_reasonable(self):
        ...
        assert result in ("simple", "reasoning")
...
class TestQualityOverride:
    def test_no_signals_returns_none(self):
        ...
        with patch("realize_core.memory.store.get_feedback_signals", side_effect=ImportError):
