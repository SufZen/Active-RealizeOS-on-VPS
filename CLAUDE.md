# CLAUDE.md — Active RealizeOS VPS Instance

> This file mirrors `AGENTS.md` — keep them in sync. Both exist so any AI coding harness (Claude Code reads `CLAUDE.md`, Codex/Cursor read `AGENTS.md`) gets the same picture.
